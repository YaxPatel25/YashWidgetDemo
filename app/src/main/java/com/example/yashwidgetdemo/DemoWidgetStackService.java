package com.example.yashwidgetdemo;
...
public class DemoWidgetStackService extends RemoteViewsService{
    ...
    public RemoteViewsFactory onGetViewFactory(Intent intent) {
        //return of an object of DemoWidgetStackViewsFactory
...
class DemoWidgetStackViewsFactory implements RemoteViewsService.RemoteViewsFactory{
    ...
    public RemoteViews getViewAt(int i) {
        ...
        int num = i + 1;
        String img_id = "img_" + num;

        view.setImageViewResource(R.id.stack_image,context.getResources().getIdentifier(img_id, "drawable", context.getPackageName()));
